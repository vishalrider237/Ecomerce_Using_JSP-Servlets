                 ...
                 <div class="card-body">
                     ...
                     <form action="OrderServlet" method="post">
                         ...
                         <div class="form-group">
                             ...
                             <input name="name" value="<%=user.getUserName()%>" type="text" class="form-control" id="name" aria-describedby="emailHelp1" placeholder="Enter Name">
                         </div>
                         <div class="form-group">
                             <label for="phone">Your Phone Number</label>
                             <input name="Iphone" value="<%=user.getUserPhone()%>" type="text" class="form-control" id="phone" aria-describedby="emailHelp1" placeholder="Enter Contact Number" >
                         </div>
                        <div class="form-group">
